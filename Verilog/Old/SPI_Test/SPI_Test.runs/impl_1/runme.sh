...
HD_PWD='D:/SeniorProject/Oscilloscope_Senior_Project/Verilog/SPI_Test/SPI_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Buffer_FIFO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Buffer_FIFO.tcl -notrace
