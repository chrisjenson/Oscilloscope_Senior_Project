...
*/
cy_stc_scb_i2c_config_t const I2C_MASTER_config =
{
...
*
* \globalvars
* \ref I2C_MASTER_initVar - used to check initial configuration,
...
void I2C_MASTER_Start(void)
{
    ...
    {
        /* Configure component */
        (void) Cy_SCB_I2C_Init(I2C_MASTER_HW, &I2C_MASTER_config, &I2C_MASTER_context);

    #if (I2C_MASTER_ENABLE_MASTER)
        /* Configure desired data rate */
        (void) Cy_SCB_I2C_SetDataRate(I2C_MASTER_HW, I2C_MASTER_DATA_RATE_HZ, I2C_MASTER_CLK_FREQ_HZ);

        #if (I2C_MASTER_MANUAL_SCL_CONTROL)
            Cy_SCB_I2C_MasterSetLowPhaseDutyCycle (I2C_MASTER_HW, I2C_MASTER_LOW_PHASE_DUTY_CYCLE);
            Cy_SCB_I2C_MasterSetHighPhaseDutyCycle(I2C_MASTER_HW, I2C_MASTER_HIGH_PHASE_DUTY_CYCLE);
        #endif /* (I2C_MASTER_MANUAL_SCL_CONTROL) */
    #endif /* (I2C_MASTER_ENABLE_MASTER) */

        /* Hook interrupt service routine */
    #if defined(I2C_MASTER_SCB_IRQ__INTC_ASSIGNED)
        (void) Cy_SysInt_Init(&I2C_MASTER_SCB_IRQ_cfg, &I2C_MASTER_Interrupt);
    #endif /* (I2C_MASTER_SCB_IRQ__INTC_ASSIGNED) */

        I2C_MASTER_initVar = 1U;
    }
