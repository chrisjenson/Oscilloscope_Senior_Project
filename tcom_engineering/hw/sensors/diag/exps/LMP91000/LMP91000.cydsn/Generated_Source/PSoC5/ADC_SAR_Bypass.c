...
*
* \funcusage
*  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_Read  
*******************************************************************************/
...
* preferred ADC_SAR_Bypass_Read() API because the 
* ADC_SAR_Bypass_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: ADC_SAR_Bypass_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use ADC_SAR_Bypass_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - ADC_SAR_Bypass_0_INTR       (First pin in the list)
    *  - ADC_SAR_Bypass_1_INTR       (Second pin in the list)
    *  - ...
    *  - ADC_SAR_Bypass_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_SetInterruptMode
    *******************************************************************************/
    void ADC_SAR_Bypass_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & ADC_SAR_Bypass_0_INTR) != 0u) 
		{ 
			 ADC_SAR_Bypass_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet ADC_SAR_Bypass_SUT.c usage_ADC_SAR_Bypass_ClearInterrupt
    *******************************************************************************/
