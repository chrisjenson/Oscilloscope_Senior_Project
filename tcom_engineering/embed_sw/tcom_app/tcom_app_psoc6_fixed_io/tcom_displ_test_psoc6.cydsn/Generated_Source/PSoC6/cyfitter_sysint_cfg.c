...
/* ARM CM4 */
    ...
    const cy_stc_sysint_t UART_KITPROG_USB_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)UART_KITPROG_USB_SCB_IRQ__INTC_NUMBER,
        .intrPriority = UART_KITPROG_USB_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
