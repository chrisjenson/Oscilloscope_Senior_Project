...
main( void )
{
    ...
    //cm4.TxBuffer[0] = 0b0100010000000000 | cm4.Trigger;     //010 00100 00000000
    cm4.TxBuffer[0] = 0b0100010000000000;     //010 00100 00000000
    
    //construct write commmand for updating on-bit in register 9
    //cm4.TxBuffer[1] = 0b0100100100000000 | cm4.onBit;     //010 01001 00000000
    cm4.TxBuffer[1] = 0b0100100100000000;     //010 01001 00000000
    
    //construct read commmand for checking a trigger event in register 15
    cm4.TxBuffer[2] = 0b0010111100000000;     //001 01111 00000000
    
    //Send a read ram command to read 1024x2 samples 
    cm4.TxBuffer[3] = 0b0110100000000000;  //011 01001 00000000
