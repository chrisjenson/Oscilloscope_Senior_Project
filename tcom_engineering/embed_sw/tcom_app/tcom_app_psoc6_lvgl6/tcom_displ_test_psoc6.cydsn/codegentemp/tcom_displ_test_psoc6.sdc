...
# Date: Mon, 30 Nov 2020 03:10:36 GMT
#set_units -time ns
...
create_generated_clock -name {SPIM_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 5 11} -nominal_period 74.999999999999986 [list [get_pins {ClockBlock/ff_div_5}]]
